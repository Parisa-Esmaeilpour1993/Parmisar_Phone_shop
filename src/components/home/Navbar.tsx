      ...
      {navLinks.map((link) =>
        link.path === "/news" ? (
          ...
          >
            ...
            {isNewsOpen && (
              <div
                className="absolute -left-16 mt-3 w-36 bg-white shadow-lg rounded-lg border border-gray-300 z-50 text-center"
                onMouseEnter={() => setIsNewsOpen(true)}
                onMouseLeave={() => setIsNewsOpen(false)}
              >
                <Link
                  href="https://digiato.com/topic/tech"
                ...
                <Link
                  href="https://mobo.news/blog/news/"

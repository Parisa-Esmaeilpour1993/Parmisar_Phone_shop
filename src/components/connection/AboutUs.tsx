    ...
    <div className="font-sans">
      <header className="relative bg-white h-[50vh] w-full ">
        ...
        <div className="absolute left-17 z-10">
          <Image
            ...
            width={400}
            height={400}
            className="object-contain  rounded-bl-2xl rounded-br-2xl"
          />
        </div>
      </header>
      ...
      <main className="px-8">
        <section className="mb-12 flex items-center justify-between">
          ...
          <div className="flex flex-col justify-end items-end relative z-20">
        ...
        <h2 className="text-3xl mt-40 font-bold text-gray-800  text-center">
        ...
        <h2 className="text-3xl mt-40 mb-10 font-bold text-gray-800  text-center">
